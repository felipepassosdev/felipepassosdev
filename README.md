...
<h4>Ambev 🍺<h4>
  <p>Atualmente estou na BEES, parte de tecnologia da Maior cervejaria do mundo. No nosso time usamos tecnologias como React, Redux, Testes unitários usando Enzyme e Jest. O projeto que trabalhamos atualmente é um marketplace de produtos para bares e estabelecimentos relacionados a cerveja.<p>
  
<h4>Kroton 📚<h4>
  <p>Trabalhei no time Midgard da Kraton ( Cogna Educação ), a segunda maior empresa relacionada a educação do mundo. Referência mundial no setor da educação pelo valor de mercado e pela quantidade de alunos. Inovadora e líder no desenvolvimento e aplicação de tecnologias educacionais. Tecnologias que utilizamos no meu time são React, Redux, NodeJS.<p>

<h4>AlparService (Ambev)🍻 <h4>
